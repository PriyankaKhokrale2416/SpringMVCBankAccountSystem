...
<%
	...
	Float damount = (Float) request.getAttribute("depositAmount");
	Float bal = (Float) request.getAttribute("bal");
	Float currentBalance = bal + damount;
%>
        
   <h5 class="text-success text-center">Account Number: <span><%=acno %></span> </h5>
...
<div class="form-group">
	...
	<label class = "boldspan" >Your Current Account Balance is Rupees <span class = "bluespan" ><%=currentBalance %></span></label> <br><br>
